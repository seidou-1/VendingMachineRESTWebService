                ...
                <div class="col-md-6">
                    ...
                    <table id="contactTable" class="table table-hover">
                        <tr>
                            ...
                            <!-- For Each enhanced for loop starts-->

                            <c:forEach var="currentContact" items="${contactList}"> <!-- getting this from the controller List<Contact> contactList -->
                            <tr>
                                <td>
                        ...
                        <!-- For Each enhanced for loop stops-->
