...
public class ContactListDaoInMemImpl implements ContactListDao {
    ...
    @Override
    public List<Contact> searchContacts(Map<SearchTerms, String> criteria) {
        String firstNameSearchCriteria =  
            criteria.get(SearchTerms.FIRST_NAME);
        String lastNameSearchCriteria = 
             criteria.get(SearchTerms.LAST_NAME);
        String companySearchCriteria = 
            criteria.get(SearchTerms.COMPANY);
        String phoneSearchCriteria = 
            criteria.get(SearchTerms.PHONE);
        String emailSearchCriteria = 
            criteria.get(SearchTerms.EMAIL);
