...
public class DvdLibraryPersistenceException extends Exception { 
    ...
    public DvdLibraryPersistenceException (String message){ //This constructor takes just a string message
        super(message);
    ...
    public DvdLibraryPersistenceException (String message, Throwable cause){ //This constructor also takes a string message but also a throwable cause
